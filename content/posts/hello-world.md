...
## What's next
I would like to get RSS/Atom feeds working in short order here, if anything just to have it done. Otherwise, I really got caught up in the technical buildout and neglected writing posts... which is probably the most on-brand thing for me I can imagine. So posts, posts would be nice.
